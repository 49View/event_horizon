...
namespace GLTF2Service {
    ...
    void geomBBox( std::shared_ptr <VData> geom, tinygltf::Model *model, int meshIndex, int primitiveIndex ) {
    ...
    void addGeomBBox( IntermediateGLTF &_gltf, int meshIndex, int primitiveIndex, GeomSP hier ) {
    ...
    void addMeshBBoxNode( IntermediateGLTF &_gltf, const tinygltf::Node &node, GeomSP hier ) {
