...
//    _im.mb->buffer( ic.baseName, imageUtil::rawToPngMemory(_im.grayScaleBaseColor) );
    ...
    void saveInternalPBRComponent( IntermediateGLTF& _gltf, const IntermediateMaterial& _im,
...
//        }
    ...
    void saveMaterial( IntermediateGLTF& _gltf, const IntermediateMaterial& im ) {
        saveInternalPBRComponent( _gltf, im, im.baseColor, UniformNames::diffuseTexture );
        saveInternalPBRComponent( _gltf, im, im.metallic, UniformNames::metallicTexture );
        saveInternalPBRComponent( _gltf, im, im.roughness, UniformNames::roughnessTexture );
        saveInternalPBRComponent( _gltf, im, im.normal, UniformNames::normalTexture );
    }
